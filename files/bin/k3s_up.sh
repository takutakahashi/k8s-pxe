...
K3S_OPTS="--datastore-endpoint=`cat /etc/db` --node-taint k3s-controlplane=true:NoExecute --no-deploy traefik --tls-san k8s.lab.takutakahashi.dev --tls-san 127.0.0.1 --tls-san `hostname`"
